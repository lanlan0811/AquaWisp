...
| `packages/runtime/src/runtime-host.data.json`     | independent runtime host   | Separate event/knowledge SQLite files, cycle/recovery limits and context resource budgets | zod schema plus runtime run, knowledge, recovery and context tests |
