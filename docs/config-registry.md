...
| `apps/desktop/src/desktop-config.data.json`       | Electron main/preload      | Window, runtime, session controls, action-ledger labels/icons, settings defaults, environment, secret/import limits and IPC channels | zod schema, preload drift check and packaged-process tests           |
