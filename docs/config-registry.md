...
| `apps/desktop/src/desktop-config.data.json`      | Electron main              | Window bounds, runtime working directory, RPC limits and inherited environment allowlist  | zod schema plus packaged-process integration tests              |
