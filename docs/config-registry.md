...
| `packages/runtime/src/runtime-host.data.json`     | independent runtime host   | SQLite filename, cycle/recovery limits, context budgets, checkpoint and artifact directories | zod schema plus runtime run, recovery and context integration tests |
