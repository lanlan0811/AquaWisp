...
| M2        | OpenAI-compatible dual-protocol model client, model catalog, reasoning effort, context compaction | In progress |
...
| M5        | Electron shell, conversation and knowledge UI, approvals, modes, settings                         | In progress |
